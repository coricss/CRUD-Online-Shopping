...
$con=connect();
        ...
        $sql = "SELECT * FROM tblinventory where `type`='Bottoms' AND `category`='Men'";
        $mbots = $con->query($sql) or die ($con->error);
...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a href="men-bottom.php"  class="active-men-dropdown">Bottom</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 men banner-image-container">
                <h4 class="display-4">Men's Bottoms</h4>
    ...
    <div class="container text-center">
        <div class="row">
            <?php while($row = $mbots->fetch_array()){?>
