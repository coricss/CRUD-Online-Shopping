...
$con=connect();
        ...
        $sql = "SELECT * FROM tblinventory where `type`='Tops' AND `category`='Men'";
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="men-top.php" class="active-men-dropdown">Top</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 men banner-image-container">
                <h4 class="display-4">Men's Tops</h4>
