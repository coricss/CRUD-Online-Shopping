...
$con=connect();
        ...
        $sql = "SELECT * FROM tblinventory where `type`='Tops' AND `category`='Men' order by rand() LIMIT 9";
        $data1 = $con->query($sql) or die ($con->error);
        $sql = "SELECT * FROM tblinventory where `type`='Bottoms' AND `category`='Men' order by rand() LIMIT 9";
...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 men banner-image-container"> 
                <h4 class="display-4">Men’s Attires</h4>
    ...
    <div class="container">
        <div class="header-container">
            <span class="header">Men's Tops</span>
        </div>
        <br><br><br>
        ...
        <div class="row text-center">
            ...
            <div class="col-12">
                ...
                <?php while($row = $data1->fetch_array()){ ?>
                    ...
                    <div class="row text-center">
                        <div class="col-12">
                            <a href="men-top.php"><button class="btn btn-primary btn-md">See More</button></a>
                        </div>
                     </div>
                </div>
    ...
    <div class="container">
        <div class="header-container">
            <span class="header">Men's Bottoms</span>
        </div>
        <br><br><br>
        ...
        <div class="row text-center">
            ...
            <div class="col-12">
                ...
                <?php while($row = $data2->fetch_array()){ ?>
                    ...
                    <div class="row text-center">
                        <div class="col-12">
                        <a href="men-bottom.php"><button class="btn btn-primary btn-md">See More</button></a>
                        </div>
                     </div>
                </div>
    ...
    <div class="container">
        <div class="header-container">
            <span class="header">Men's Formal Attires</span>
        </div>
        <br><br><br>
        ...
        <div class="row text-center">
            ...
            <div class="col-12">
                ...
                <?php while($row = $data3->fetch_array()){ ?>
                    ...
                    <div class="row text-center">
                        <div class="col-12">
                        <a href="men-formal-attire.php"><button class="btn btn-primary btn-md">See More</button></a>
                        </div>
                     </div>
                </div>
